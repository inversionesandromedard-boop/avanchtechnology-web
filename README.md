  ...
  <div class="planes-grid">
    ...
    <div class="plan-card" id="plan-0" onclick="selPlan(0)">
      <div class="plan-head">
        ...
        <div class="plan-name">Pyme Iniciado</div>
    ...
    <div class="plan-card" id="plan-2" onclick="selPlan(2)">
      <div class="plan-head">
        <div class="plan-icon-wrap">🏢</div>
        <div class="plan-name">Grande Pyme</div>
        <div class="plan-price-wrap">
          <span class="plan-currency">RD$</span>
      ...
      <div class="plan-body">
        <ul class="plan-feat">
          <li><span class="feat-check">✓</span>Todo lo de Experto</li>
          <li><span class="feat-check">✓</span>Usuarios ilimitados</li>
          <li><span class="feat-check">✓</span>API e integraciones</li>
          <li><span class="feat-check">✓</span>Soporte 24/7 dedicado</li>
        </ul>
  ...
  <div class="card-section">
    ...
    <div class="form-grid">
      <div class="form-field">
        ...
        <input type="text" id="f-rnc" class="inp" placeholder="Ej: 1-01-12345-6">
      </div>
      <div class="form-field">
        <label class="field-label">Nombre Legal <span class="field-req">*</span></label>
        <input type="text" id="f-legal" class="inp" placeholder="Nombre ante la DGII">
      </div>
      <div class="form-field">
        <label class="field-label">Nombre Comercial <span class="field-req">*</span></label>
        <input type="text" id="f-nombre" class="inp" placeholder="Marca de su negocio">
      </div>
      <div class="form-field">
        <label class="field-label">Representante <span class="field-req">*</span></label>
      ...
      <div class="form-field">
        ...
        <input type="tel" id="f-tel" class="inp" placeholder="Ej: 8091234567">
      </div>
      <div class="form-field">
...
function calcular() {
  ...
  var fechaProx = ca + ' de ' + mNom[m] + ' de ' + a;
...
function enviar() {
  ...
  var legal  = document.getElementById('f-legal').value.trim();
